    ...
    <div>
      <Box className={`${classes.columnDiv} ${classes.mainDiv}`} id="AboutMe">
        ...
        <Typography className={classes.bodyText}>
          ...
          <br /> <br /> I have eight months of experience as a front-end
          developer on a web development team, and I also like to work on
          developing my own programming projects in my spare time. You can find
          my {/* TODO - add resume link */}{" "}
          <Link
